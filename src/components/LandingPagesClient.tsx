...
export default function LandingPagesClient() {
  ...
  const openWhatsApp = () => {
    window.open(
      createWhatsAppUrl(CONTACT_CONFIG.whatsapp.messages.landingPage),
      "_blank",
    );
  };
  ...
  const features = [
    {
      ...
      description:
        "Criamos landing pages visualmente impressionantes que capturam a atenção do seu público e transmitem profissionalismo.",
      icon: <DesignIcon />,
    },
    {
      title: "Otimização para Conversão",
      description:
        "Estratégias comprovadas para aumentar suas taxas de conversão e transformar visitantes em clientes.",
      icon: <ChartIcon />,
    },
    {
      title: "Chatbot Inteligente",
      description:
        "Atendimento automatizado 24/7 com IA que entende e responde às necessidades dos seus clientes.",
      icon: <ChatBotIcon />,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="relative z-40 pt-20 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h1
              className={`text-5xl md:text-6xl lg:text-7xl font-black mb-6 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
            ...
            <p
              className={`text-xl text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              Transformamos sua ideia em uma landing page moderna e conversiva,
              com chatbots inteligentes integrados ao WhatsApp para maximizar
              seus resultados.
            </p>

            <div
              className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              <button
            ...
            <div
              className={`grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              {[
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Oferecemos soluções completas para impulsionar seu negócio no
              digital
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              <div
                ...
                className={`bg-white p-8 rounded-2xl shadow-lg border border-purple-50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 ${
                  activeFeature === index
                    ? "ring-2 ring-purple-200 scale-105"
                    : ""
                }`}
      ...
      {/* About Section (será renderizado pelo Server Component pai) */}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              O que nossos <span className="text-purple-600">clientes</span>{" "}
              dizem
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {[
              {
                ...
                answer:
                  "O prazo médio é de 7 a 10 dias úteis, dependendo da complexidade do projeto e da agilidade no fornecimento de conteúdo e feedback.",
              },
              {
                question: "O domínio está incluído no pacote?",
                answer:
                  "Sim, todos os nossos pacotes incluem registro de domínio por 1 ano. A renovação anual é de responsabilidade do cliente.",
              },
              {
                question: "Como funciona o chatbot para WhatsApp?",
                answer:
                  "Desenvolvemos um chatbot inteligente que se integra à API oficial do WhatsApp Business. Ele pode responder perguntas frequentes, qualificar leads e agendar consultas automaticamente.",
              },
              {
                question: "Há algum custo adicional?",
                answer:
                  "Nosso preço é transparente e inclui todos os serviços listados. A única exceção são possíveis personalizações extras solicitadas após o projeto inicial.",
              },
            ].map((faq, index) => (

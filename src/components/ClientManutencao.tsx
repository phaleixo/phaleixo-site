...
export default function ClientManutencao() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-gray-900 to-gray-700 text-white">
      {/* Hero Section Principal */}
      <section className="relative py-20 px-4 overflow-hidden">
        {/* Background com degradê adicional */}
        <div className="absolute inset-0 bg-gradient-to-tr from-purple-800/30 via-transparent to-gray-700/30"></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-purple-300 to-gray-300 bg-clip-text text-transparent">COMPUTADORES</span>
            </h1>
            
            <p className="text-lg sm:text-xl md:text-2xl mb-8 text-white-100 max-w-2xl mx-auto">
              Seu PC lento, travando ou com vírus? 
              <span className="text-white-300 font-bold"> Resolvemos HOJE!</span>
            </p>
            
            <button 
              onClick={openWhatsApp}
              className="bg-gradient-to-r from-purple-500 to-gray-500 hover:from-purple-400 hover:to-gray-400 text-white px-12 py-6 rounded-full text-xl font-bold shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center mx-auto space-x-4 cursor-pointer"
            >
              <WhatsAppIcon />
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-transparent to-purple-900/20">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-12 text-white">
            SEU PC TEM ESSES <span className="bg-gradient-to-r from-purple-300 to-gray-300 bg-clip-text text-transparent">PROBLEMAS?</span>
          </h2>
          ...
          <div className="mt-12">
            <button 
              onClick={openWhatsApp}
              className="bg-gradient-to-r from-gray-500 to-purple-500 hover:from-gray-400 hover:to-purple-400 text-white px-10 py-4 rounded-full text-lg font-bold shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer"
            >
              RESOLVER AGORA!
            </button>
          </div>
      ...
      {/* Seção de Serviços */}
      <section className="py-16 px-4 bg-gradient-to-t from-gray-900/30 to-transparent">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-center mb-12 text-white">
            NOSSOS <span className="bg-gradient-to-r from-gray-300 to-purple-300 bg-clip-text text-transparent">SERVIÇOS</span>
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white/10 backdrop-blur-sm border border-gray-400/40 p-8 rounded-lg hover:bg-white/15 transition-all duration-300">
      ...
      {/* Seção Final CTA */}
      <section className="py-20 px-4 bg-gradient-to-br from-gray-600 to-purple-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button 
            onClick={openWhatsApp}
            className="bg-white hover:bg-gray-100 text-purple-700 px-16 py-8 rounded-full text-2xl font-black shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center mx-auto space-x-4 cursor-pointer"
          >
